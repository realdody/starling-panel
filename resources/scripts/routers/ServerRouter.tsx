...
import { faDesktop, faExternalLinkAlt, faGlobe, faWifi } from '@fortawesome/free-solid-svg-icons';
...
export default () => {
    ...
    const textLimits = useMemo(
        () => ({
            ...
            memory: limits?.memory ? bytesToString(mbToBytes(limits.memory)) : 'Unlimited',
            disk: limits?.disk ? bytesToString(mbToBytes(limits.disk)) : 'Unlimited',
        }),
        [limits]
    );
