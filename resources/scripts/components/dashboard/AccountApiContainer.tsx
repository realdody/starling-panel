...
export default () => {
    ...
    return (
        <>
            <p className='text-lg font-bold mb-2'>List of your keys</p>
            ...
            {keys.length === 0 ? (
                ...
                keys.map((key, index) => (
                    <div key={key.identifier} css={[tw`flex items-center`, index > 0 && tw`mt-2`]}>
            ...
            <p className='text-lg font-bold mt-4 mb-2'>Create API key</p>
