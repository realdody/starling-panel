        ...
        <PageContentBlock title={'Dashboard'} showFlashKey={'dashboard'}>
                ...
                <div className='waves'>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1440 320'>
                        <path
                            fill='#333'
                            fillOpacity='1'
                            d='M0,224L30,218.7C60,213,120,203,180,192C240,181,300,171,360,186.7C420,203,480,245,540,250.7C600,256,660,224,720,229.3C780,235,840,277,900,272C960,267,1020,213,1080,197.3C1140,181,1200,203,1260,218.7C1320,235,1380,245,1410,250.7L1440,256L1440,320L1410,320C1380,320,1320,320,1260,320C1200,320,1140,320,1080,320C1020,320,960,320,900,320C840,320,780,320,720,320C660,320,600,320,540,320C480,320,420,320,360,320C300,320,240,320,180,320C120,320,60,320,30,320L0,320Z'
                        ></path>
                    </svg>
                    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1440 320'>
                        <path
            ...
            <div className='homeServers'>
                ...
                <div className='w-full flex justify-between items-center mb-4 relative'>
                    ...
                    {rootAdmin && (
                        <div
                            css={tw`flex justify-end items-center`}
                            className='switcher w-fit absolute'
